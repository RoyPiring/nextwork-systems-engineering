...
In this project, I built a clinical AI assistant using Claude with embedded safety guardrails. In this project, I built a reusable prompt template that generates structured lesson plans using Claude. In this project, I applied prompt engineering techniques to improve how AI supports research workflows.
