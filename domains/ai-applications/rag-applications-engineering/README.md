...
This project implements a retrieval-augmented generation (RAG) chatbot using Amazon Bedrock. This project implements a command-line interface for interacting with a retrieval-augmented generation (RAG) chatbot using Amazon Bedrock. This project implements a retrieval-augmented generation (RAG) chatbot backed by Amazon Bedrock and exposed through a custom API.
