...
This series documents the design and implementation of a foundational AWS Virtual Private Cloud architecture. This project documents the construction of a foundational Amazon VPC to establish controlled network isolation within AWS. Amazon VPC is a logically isolated network boundary within an AWS account.
