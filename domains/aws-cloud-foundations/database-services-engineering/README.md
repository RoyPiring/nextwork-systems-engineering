...
This project set focuses on building and evaluating managed database services on AWS. This project demonstrates the creation of an Amazon DynamoDB table and the loading of sample data using AWS-managed tooling. Amazon DynamoDB is a fully managed NoSQL key value and document database designed for predictable performance at scale.
