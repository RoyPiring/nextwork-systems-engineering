...
This project provisions a static website hosted on Amazon S3. This project implements a controlled data transfer path between Amazon S3 and Google Cloud Storage using Google Cloud Storage Transfer Service.
